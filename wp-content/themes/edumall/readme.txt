...
= 4.4.4 - July 21, 2025 =
- Fixed:
Fix security issue on AJAX action lazy loader templates.
...
= 4.4.1 - June 27, 2025 =
- Fixed:
Fix course price not showing when selling by WC
...
Compatible with Tutor subscription add-on
Updated outdated templates of WooCommerce 9.9.0

= 4.3.1 - Apr 23, 2025 =
- Updated:
Revolution Slider plugin v.6.7.32
Edumall Addons plugin v.1.3.0
- Fixed
Fix course featured UI not show properly.
Fix course filter widgets
...
= 4.0.6 - October 14, 2024 =
- Updated:
Insight Core plugin - v.2.7.1
Revolution Slider plugin - v.6.7.20

= 4.0.5 - September 26, 2024 =
- Updated:
Tutor LMS Pro plugin - v.2.7.6
Revolution Slider plugin - v.6.7.19

= 4.0.4 - September 16, 2024 =
- Fixed:
Fix Elementor widgets used waypoint broken in Elementor 2.24.x

= 4.0.3 - September 13, 2024 =
- Updated:
Tutor LMS Pro plugin - v.2.7.5
Tutor LMS Certificate Builder plugin - v.1.1.2
- Fixed:
Fixed some minor style errors
Fix for quiz attempt history not showing properly
Fix quiz body still start when remaining count limit
WooCommerce 9.3.1 outdated templates

= 4.0.2 - August 23, 2024 =
- Updated:
Revolution Slider plugin - v.6.7.18
- Fixed:
WooCommerce 9.2.0 outdated templates
...
= 4.0.0 - July 17, 2024 =
- Updated:
Tutor LMS Pro plugin - v.2.7.3
Tutor LMS Certificate Builder plugin - v.1.1.1
...
3.9.10 - July 3, 2024
- Updated:
Revolution Slider plugin - v.6.7.14
- Fixed:
Create a new bundle course frontend
Fix Course powerTips not show
Fix translation
Fix Registration Date format
Fix Course builder logo

3.9.9 - Jun 19, 2024
- Updated:
Tutor LMS Pro plugin 2.7.2
Tutor LMS Certificate Builder plugin 1.1.0
- Fixed:
Compatible with Elementor Pro v.3.22.0
WooCommerce outdated templates
Fix Single Quiz drip_content_protection
