...
if ( ! class_exists( 'Edumall_Enqueue' ) ) {
	class Edumall_Enqueue {
		...
		public function register_swiper() {
			...
			wp_register_style( 'swiper', EDUMALL_THEME_URI . '/assets/libs/swiper/css/swiper.min.css', array(), '8.4.5' );
			wp_register_script( 'swiper', EDUMALL_THEME_URI . "/assets/libs/swiper/js/swiper{$min}.js", [
				'jquery',
				'imagesloaded',
			], '8.4.5', true );
		...
		public function polyfill_script() {
			wp_enqueue_script( 'intersection-observer', EDUMALL_THEME_URI . '/assets/libs/polyfill/intersection-observer.min.js', array(), null, true );
		}
		...
		public function frontend_scripts() {
			 ...
			 */
			wp_register_style( 'edumall-woocommerce', EDUMALL_THEME_URI . "/woocommerce{$rtl}.css", array(), EDUMALL_THEME_VERSION );

			wp_register_style( 'font-awesome-pro', EDUMALL_THEME_URI . '/assets/fonts/awesome/css/fontawesome-all.min.css', array(), '6.4.2' );
			...
			wp_register_style( 'justifiedGallery', EDUMALL_THEME_URI . '/assets/libs/justifiedGallery/css/justifiedGallery.min.css', array(), '3.7.0' );
			...
			wp_register_style( 'lightgallery', EDUMALL_THEME_URI . '/assets/libs/lightGallery/css/lightgallery.min.css', array(), '1.6.12' );
			wp_register_script( 'lightgallery', EDUMALL_THEME_URI . '/assets/libs/lightGallery/js/lightgallery-all.min.js', array(
				'jquery',
			), '1.6.12', true );

			wp_register_style( 'magnific-popup', EDUMALL_THEME_URI . "/assets/libs/magnific-popup/magnific-popup{$min}.css", array(), '1.1.0' );
			wp_register_script( 'magnific-popup', EDUMALL_THEME_URI . "/assets/libs/magnific-popup/jquery.magnific-popup{$min}.js", array( 'jquery' ), '1.1.0', true );

			wp_register_style( 'growl', EDUMALL_THEME_URI . '/assets/libs/growl/css/jquery.growl.min.css', array(), '1.3.3' );
			wp_register_script( 'growl', EDUMALL_THEME_URI . '/assets/libs/growl/js/jquery.growl.min.js', array( 'jquery' ), '1.3.3', true );

			wp_register_script( 'matchheight', EDUMALL_THEME_URI . '/assets/libs/matchHeight/jquery.matchHeight-min.js', array( 'jquery' ), '0.7.2', true );
			...
			wp_register_script( 'picturefill', EDUMALL_THEME_URI . '/assets/libs/picturefill/picturefill.min.js', array( 'jquery' ), '2.3.1', true );

			wp_register_script( 'mousewheel', EDUMALL_THEME_URI . '/assets/libs/mousewheel/jquery.mousewheel.min.js', array( 'jquery' ), '3.1.13', true );

			$google_api_key = $this->get_google_api_key();
			wp_register_script( 'edumall-gmap3', EDUMALL_THEME_URI . '/assets/libs/gmap3/gmap3.min.js', array( 'jquery' ), '7.2', true );
			wp_register_script( 'edumall-maps', EDUMALL_PROTOCOL . '://maps.google.com/maps/api/js?key=' . $google_api_key . '&amp;language=en' );

			wp_register_script( 'isotope-masonry', EDUMALL_THEME_URI . "/assets/js/isotope.pkgd{$min}.js", array( 'jquery' ), '3.0.6', true );
			wp_register_script( 'isotope-packery', EDUMALL_THEME_URI . "/assets/libs/packery-mode/packery-mode.pkgd{$min}.js", array( 'jquery' ), '2.0.1', true );
			 ...
			 */
			wp_enqueue_style( 'edumall-style', get_template_directory_uri() . "/style{$rtl}.css", array(), EDUMALL_THEME_VERSION );
			...
			if ( ! wp_script_is( 'elementor-waypoints', 'registered' ) ) {
				wp_register_script( 'elementor-waypoints', EDUMALL_THEME_URI . '/assets/libs/elementor-waypoints/jquery.waypoints.min.js', array( 'jquery' ), '4.0.1', true );
			}
			...
			wp_enqueue_script( 'jquery-smooth-scroll', EDUMALL_THEME_URI . '/assets/libs/smooth-scroll/jquery.smooth-scroll.min.js', array( 'jquery' ), '2.2.0', true );

			wp_enqueue_script( 'edumall-swiper-wrapper' );

			wp_enqueue_script( 'smartmenus' );

			wp_enqueue_style( 'perfect-scrollbar', EDUMALL_THEME_URI . '/assets/libs/perfect-scrollbar/css/perfect-scrollbar.min.css', array(), '0.6.14' );
			wp_enqueue_script( 'perfect-scrollbar', EDUMALL_THEME_URI . '/assets/libs/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js', array( 'jquery' ), '0.6.14', true );
			...
			$js_variables = array(
				...
				'nonce'                     => wp_create_nonce( 'edumall-security' ),
		...
		public function rtl_styles() {
			wp_register_style( 'edumall-style-rtl-custom', EDUMALL_THEME_URI . '/style-rtl-custom.css', array(), EDUMALL_THEME_VERSION );

			if ( is_rtl() ) {
				wp_enqueue_style( 'edumall-style-rtl-custom' );
			}
		}

		public function dark_skin() {
			wp_register_style( 'edumall-skin-dark', EDUMALL_THEME_URI . '/style-dark.css', array(), EDUMALL_THEME_VERSION );
