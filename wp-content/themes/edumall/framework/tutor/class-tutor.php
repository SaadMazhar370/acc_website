...
if ( ! class_exists( 'Edumall_Tutor' ) ) {
	class Edumall_Tutor {
		...
		public function initialize() {
			...
			// require_once EDUMALL_TUTOR_DIR . '/hooks.php';
			...
			// Edumall_Hooks::instance()->initialize();
		...
		public function has_enrolled_content_access( $content, $object_id = 0, $user_id = 0 ) {
			...
			if ( tutor_utils()->is_enrolled( $course_id, $user_id ) || tutor_utils()->has_user_course_content_access() ) {
				return true;
			}
