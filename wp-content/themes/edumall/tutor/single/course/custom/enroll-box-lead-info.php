...
<div class="tutor-single-course-meta tutor-meta-top">
	...
	<?php if ( tutor_utils()->get_option( 'enable_course_level', true, true ) ) { ?>
	...
	<?php
	$enable_course_duration = get_tutor_option( 'enable_course_duration' );
	$course_duration        = Edumall_Tutor::instance()->get_course_duration_context();

	if ( ! empty( $course_duration ) && $enable_course_duration ) { ?>
