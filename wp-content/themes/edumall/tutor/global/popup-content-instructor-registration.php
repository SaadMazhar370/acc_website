...
<div class="popup-content-body">
	<?php if ( ! is_user_logged_in() ) : ?>
		<form id="edumall-instructor-registration-form" class="edumall-instructor-registration-form" method="post">
			...
			if ( $privacy_page_id ) {
				$privacy_link_html = sprintf( '<a href="%1$s" class="edumall-privacy-policy-link" target="_blank">%2$s</a>', esc_url( get_permalink( $privacy_page_id ) ), $privacy_link_html );
			}
			...
			if ( $terms_conditions_page_id ) {
				$terms_conditions_link_html = sprintf( '<a href="%1$s" class="edumall-terms-conditions-link" target="_blank">%2$s</a>', esc_url( get_permalink( $terms_conditions_page_id ) ), $terms_conditions_link_html );
			}
			?>
	...
	<?php else: ?>
		...
		<?php elseif ( Edumall_Tutor::instance()->is_instructor() ) : ?>
			<div class="popup-form-footer">
				...
				$profile_text = esc_html__( 'Go to Dashboard', 'edumall' );
