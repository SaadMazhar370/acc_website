...
//		add_action( 'wp_ajax_nopriv_kirki_fonts_standard_all_get', array( $this, 'get_standardfonts_json' ) );
		add_action( 'customize_controls_print_footer_scripts', array( $this, 'print_fonts_json' ) );
	...
	public function print_fonts_json() {
		$json_file = wp_normalize_path(dirname(__FILE__) . '/webfonts.json');

		if ( file_exists( $json_file ) ) {
			$json_data = file_get_contents( $json_file );
			echo '<script id="kirki-fonts-google-json" type="application/json">' . $json_data . '</script>';
		}

		$standard_fonts_json = wp_json_encode( Kirki_Fonts::get_standard_fonts() );
		echo '<script id="kirki-fonts-standard-json" type="application/json">' . $standard_fonts_json . '</script>';
	}
}
